...
import { getBookingByCodigo, getPanoramaById, getScheduleById, getSiteSettings } from "@/lib/db";
...
export default async function ConfirmacionPage({ params }: { params: { codigo: string } }) {
  ...
  if (!booking) notFound();
  const [panorama, schedule, settings] = await Promise.all([
    ...
    <div className="section py-16 max-w-xl">
      <div className="card p-8 text-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href={whatsappLink(`Hola, acabo de reservar el código ${booking.codigo_reserva} en Travesías AnSup.`, settings.whatsapp_number)} target="_blank" rel="noreferrer" className="btn-whatsapp w-full">
