    ...
    <div className="section py-12 max-w-2xl">
      ...
      {resultado && (
        <div className="card p-6 space-y-6">
          ...
          <a href={whatsappLink(`Hola, tengo una consulta sobre mi reserva ${resultado.booking.codigo_reserva}.`)} target="_blank" rel="noreferrer" className="btn-whatsapp w-full">
