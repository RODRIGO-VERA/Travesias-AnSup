...
import { getPanoramas, getActiveNotices, getFaq } from "@/lib/db";
import { whatsappLink } from "@/lib/utils";

export const dynamic = "force-dynamic";

export default async function HomePage() {
  const [allPanoramas, avisos, allFaq] = await Promise.all([getPanoramas(), getActiveNotices(), getFaq()]);
        ...
        <div className="relative overflow-hidden rounded-xl2 shadow-soft">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-center gap-4 p-8 sm:p-14 text-white max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3 mt-2">
              ...
              <a href={whatsappLink("Hola, quiero consultar por Travesías AnSup.")} target="_blank" rel="noreferrer" className="btn-whatsapp">
