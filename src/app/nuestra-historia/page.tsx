  ...
  return (
    <div>
      <div className="relative aspect-[16/9] max-h-[380px] w-full">
        <Image src="/images/grupo-tablas-cabana.jpg" alt="Equipo Travesías AnSup" fill className="object-cover object-[center_25%]" />
      ...
      <div className="section py-12 grid gap-10 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden"><Image src="/images/grupo-celebrando-manos.jpg" alt="" fill className="object-cover object-[center_25%]" /></div>
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden mt-6"><Image src="/images/inspirador-remo-arriba.jpg" alt="" fill className="object-cover object-[center_25%]" /></div>
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden"><Image src="/images/grupo-selfie-sol.jpg" alt="" fill className="object-cover object-[center_25%]" /></div>
          <div className="relative aspect-[4/3] rounded-xl overflow-hidden mt-6"><Image src="/images/accion-remando-lago.jpg" alt="" fill className="object-cover object-[center_25%]" /></div>
        </div>
      </div>
    </div>
  );
