...
import { getPanoramaBySlug } from "@/lib/db";
      ...
      <div className="section py-10 grid lg:grid-cols-3 gap-10">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {resto.map((img) => (
                  <div key={img.id} className="relative h-40 rounded-xl overflow-hidden">
                    <Image src={img.url} alt={img.titulo || panorama.nombre} fill className="object-cover" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <aside className="lg:col-span-1">
          <div className="card p-6 sticky top-24 space-y-4">
            ...
            <a
              href={whatsappLink(`Hola, quiero consultar por un recorrido de Travesías AnSup en ${panorama.nombre}.`)}
