    ...
    <footer className="mt-16 bg-deep-800" style={{ color: "#D9D3C5" }}>
      <div className="section py-12 grid gap-10 sm:grid-cols-3">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href={whatsappLink("Hola, quiero consultar por Travesías AnSup.")} target="_blank" rel="noreferrer" className="hover:text-teal-300 transition">
                WhatsApp
              </a>
            </li>
            <li>
              <a href={instagram} target="_blank" rel="noreferrer" className="hover:text-teal-300 transition">
